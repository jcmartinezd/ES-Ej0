...
namespace ConsecionarioGitH.Controllers
{
    public class VehiculoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Placa,Modelo,Marca")] Vehiculo vehiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Placa,Modelo,Marca")] Vehiculo vehiculo)
        {
            if (ModelState.IsValid)
            {
